...
<!-- START "Аренда автокран Ивановец 14 тонн 14 метров" -->
<?php require_once './templates/topsingle.php'; ?>
<!-- END "Аренда автокран Ивановец 14 тонн 14 метров" -->

<!-- START "Характеристики и описание автокрана" -->
<?php require_once './templates/chardesc.php'; ?>
<!-- END "Характеристики и описание автокрана" -->

<!-- START "Похожие модели" -->
<?php require_once './templates/catalogchar.php'; ?>
<!-- END "Похожие модели" -->
