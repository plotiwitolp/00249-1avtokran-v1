...
<body>
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="top__inner">
          ...
          <div class="top__first">
            <img src="./assets/img/top_img_1.png" alt="автокран">
          </div>
          ...
          <div class="top__second">
            ...
            <div class="top__list">
              <div class="top__list-item">Подача в течение 20 минут!</div>
              <div class="top__list-item">Оплата с НДС и без</div>
              <div class="top__list-item">Опытные водители граждане РФ</div>
              <div class="top__list-item">Вся техника в собственности</div>
            </div>

            <div class="top__btn-wrap">
              <div class="btn">Заказать аренду</div>
            </div>
    ...
    <!-- START "Наши автокраны 12 тонн" -->
    <div class="catalogchar">
      <div class="container">
        <div class="catalogchar__inner">

          <h2>Наши автокраны 12 тонн</h2>

          <div class="catalogchar__list">
          ...
          <div class="catalogchar__btn-wrap">
      ...
      <div class="container">
        <div class="service__inner">
          ...
          <div class="service__list">
            ...
            <div class="service__item">
              <div class="service__item-img">
                <img src="./assets/img/catalogchar_img.png" alt="Разгрузка и погрузка стройматериалов">
              </div>
          ...
          <div class="service__btn-wrap">
            <div class="btn">Полный список услуг</div>
          </div>
    ...
    <div class="exprom">
      <div class="container">
        <div class="exprom__inner">

          <div class="exprom__before"></div>
          ...
          <div class="exprom__second">
            ...
            <div class="exprom__second-txt">
              ...
              <p>Для успешных проектов выбирайте Первый Автокран - ваш надежный партнер в аренде спецтехники!</p>
            </div>
            <div class="exprom__second-btn-wrap">
              <div class="btn">Оставить заявку</div>
            </div>
          </div>

          <div class="exprom__after"></div>
